    ...
    <div className={styles.welcomeContainer}>
      <div className={styles.overlay}>
        ...
        <ul className={styles.welcomeList}>
          <li className={styles.welcomeQuestion}>
            Have you ever signed up for a trial and then forgot to cancel?{" "}
          </li>
          <li className={styles.welcomeQuestion}>
            Did you end up paying for a full month because you cancelled your
            subscription one day too late?
          </li>
          <li className={styles.welcomeQuestion}>
            Did you completely forget that you were even subscribed to some
            service until you were charged?
          </li>
        </ul>
